...
USE hr;
-- unsigned is a datatype attached to integer columns which means it can not contain 
-- negative values, only nonnegative values are allowed. 
-- The maximum range with unsigned int is 0-4294967295.
